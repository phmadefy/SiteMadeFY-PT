...
$mail->Host = "mail.gusttavolima.com.br"; // Endereço do servidor SMTP
$mail->SMTPAuth = true; // Autenticação
//$mail->SMTPSecure = "tls";
$mail->Username = 'naoresponder@gusttavolima.com.br'; // Usuário do servidor SMTP
$mail->Password = 'iBS;ZUR8QHrV'; // Senha da caixa postal utilizada
//$mail->Port = '587';

//Define o remetente
$mail->From = "naoresponder@gusttavolima.com.br"; 
$mail->FromName = "Gusttavo Lima";

//Define os destinatário(s)
$mail->AddAddress('contato@gusttavolima.com.br', 'Contato');
...
if ( $erro ) {
 echo $erro;
	...
	$mensagem	   .= '<table border="0" cellpadding="0" cellspacing="0" width="100%" style="background: #0C0413;">';
	$mensagem	   .= '<tr>';
	$mensagem	   .= '<td>';
	...
	$mensagem	   .= '<img src="https://www.gusttavolima.com.br/2020/wp-content/themes/gusttavo-lima/img/logo.png" style="display: block;" />';
	$mensagem	   .= '</td>';
	$mensagem	   .= '</tr>';
	$mensagem	   .= '<tr>';
	...
	$mensagem	   .= "<p><b>País: </b>" . $pais . "</p>\n\r";
	$mensagem	   .= "<p><b>Departamento: </b>" . $departamento . "</p>\n\r";
	...
	$mensagem	   .= '© COPYRIGHT - Gusttavo Lima';
	$mensagem	   .= '</td>';
	$mensagem	   .= '</tr>';
	$mensagem	   .= '</table>';
	$mensagem	   .= '</td>';
